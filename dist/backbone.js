...
//   [array] ../src/backbone/template/panel.tmpl -> 3.tmpl
//   [array] ../src/backbone/inspector/template/template_hintPopup.tmpl -> d.tmpl
//   [array] ../src/backbone/inspector/template-info/template/window.tmpl -> c.tmpl
//   [array] ../src/backbone/inspector/template-info/template/tree/comment.tmpl -> b.tmpl
//   [array] ../src/backbone/inspector/template-info/template/tree/text.tmpl -> a.tmpl
//   [array] ../src/backbone/inspector/template-info/template/tree/attritubes.tmpl -> 9.tmpl
//   [array] ../src/backbone/inspector/template-info/template/tree/element.tmpl -> 8.tmpl
//   [array] ../src/backbone/inspector/template-info/template/tree/attritube.tmpl -> 7.tmpl
//   [array] ../src/backbone/inspector/template-info/template/tree/attribute-value.tmpl -> 6.tmpl
//   [array] ../src/backbone/inspector/template-info/template/tree/attribute-value-static.tmpl -> 5.tmpl
//   [array] ../src/backbone/inspector/template-info/template/js-source-popup.tmpl -> 4.tmpl
...
//   [object] ../src/backbone/template/reloadRequired.l10n -> 0.l10n
//   [function] ../src/backbone/api/file.js -> z.js
...
//   [function] ../src/backbone/inspector/template.js -> y.js
//   [function] ../src/backbone.js -> 1.js
...
//   [function] ../src/backbone/inspector/template-info/index.js -> 10.js
//   [function] ../src/backbone/inspector/template-info/parse-dom.js -> 11.js
//   [function] ../src/backbone/inspector/template-info/build-tree.js -> 12.js
//   [function] ../src/backbone/inspector/template-info/js-source-popup.js -> 13.js
...
//   [function] ../src/backbone/panel.js -> u.js
//   [function] ../src/backbone/index.js -> t.js
...
var __resources__ = {
  "0.css": '/*@import url(/node_modules/basisjs/src/basis/ui/templates/highlight/SourceCode.css);*/\n\n\n  .Basis-SyntaxHighlight\n  {\n    border: 1px solid #E0E0E0;\n    padding: 1px;\n    margin: 0 1ex;\n    overflow: hidden;\n\n    font-family: Consolas, monospace;\n    font-size: 100%;\n    line-height: 1.4em;\n    white-space: pre;   /* needs for line endings preserving */\n  }\n\n  .Basis-SyntaxHighlight .line\n  {\n    position: relative; /* for webkit, otherwise if user starts select from numbering\n                           selection begins from block begining */\n    zoom: 1;            /* IE6/7 */\n    /*white-space: pre;*/   /* preseving line endings in IE7 */\n\n    background: #F0F0F0;\n  }\n\n  .Basis-SyntaxHighlight .even\n  {\n    background-color: #F8F8F8;\n  }\n  /*.Basis-SyntaxHighlight .line:hover\n  {\n    background: #DDD;\n  }*/\n\n  .Basis-SyntaxHighlight .lineNumber\n  {\n    position: absolute;\n    left: 0;\n\n    padding: 0 .5ex;\n    margin: 0;\n    width: 6ex;\n    line-height: 1.4em;\n    height: 1.4em;\n\n    background: none;\n    border: none;\n    font-family: Consolas, monospace;\n    font-size: 100%;\n    text-align: right;\n    color: #666;\n\n      -ms-user-select: none;    /* prevent block including to selection */\n      -moz-user-select: none;\n      -webkit-user-select: none;\n    user-select: none;\n    pointer-events: none;        /* actually this rule makes unnecessary .over block,\n                                    but it lacks of browsers support */\n  }\n\n  .Basis-SyntaxHighlight .over\n  {\n    display: block;\n    position: absolute;\n    left: 0;\n    width: 7ex;\n    height: 1.4em;\n    z-index: 1;\n    background: url(data:image/png;base64,);  /* we need set transporent background, otherwise IE & Opera\n                                                 pass mouse event to underline blocks */\n  }\n\n  .Basis-SyntaxHighlight .lineContent\n  {\n    padding-left: 1ex;\n    padding-right: 1ex;\n    border-left: 2px solid #33BB66;\n    display: block;\n    white-space: pre-wrap;      /* preserve formating but allow word breaking */\n  }\n\n  .Basis-SyntaxHighlight .hasLineNumber .lineContent\n  {\n    margin-left: 7ex;\n    padding-left: 2.5ex;\n  }\n\n  .Basis-SyntaxHighlight .token-string\n  {\n    color: blue;\n  }\n  .Basis-SyntaxHighlight .token-comment \n  {\n    color: #008200;\n  }\n  .Basis-SyntaxHighlight .token-keyword\n  {\n    color: #006699;\n    font-weight: bold;\n  }\n  .Basis-SyntaxHighlight .token-key\n  {\n    color: #006699;\n  }\n  .Basis-SyntaxHighlight .token-value\n  {\n    color: #AA8844;\n    font-weight: bold;\n  }\n\n/*@import url(/node_modules/basisjs/src/basis/ui/templates/popup/Popup.css);*/\n\n\n  .Basis-Popup\n  {\n    position: absolute;\n    background-color: white;\n    border: 1px solid #CCC;\n    box-shadow: 1px 1px 5px rgba(0,0,0,.2);\n  }\n  .Basis-Popup.visible,\n  .Basis-Popup.visible-anim,\n  .Basis-Popup.hidden,\n  .Basis-Popup.hidden-anim\n  {\n\n  }\n\n  .Basis-Popup-Content\n  {\n    min-height: 1em;\n    min-width: 100px;\n  }\n\n  .popup-v-left-top,\n  .popup-v-right-top,\n  .popup-v-center-top,\n  .popup-v-left-center,\n  .popup-v-right-center,\n  .popup-v-center-center,\n  .popup-v-left-bottom,\n  .popup-v-right-bottom,\n  .popup-v-center-bottom,\n  .popup-h-left-top,\n  .popup-h-right-top,\n  .popup-h-center-top,\n  .popup-h-left-center,\n  .popup-h-right-center,\n  .popup-h-center-center,\n  .popup-h-left-bottom,\n  .popup-h-right-bottom,\n  .popup-h-center-bottom\n  {\n\n  }\n\n/*@import url(/node_modules/basisjs/src/basis/ui/templates/popup/Balloon.css);*/\n\n\n  .Basis-Balloon\n  {\n    position: absolute;\n    min-height: 12px; /* 4 (top) + 6 (bottom) + 2 (border) */\n    min-width: 60px;\n  }\n\n  .Basis-Balloon.visible-anim,\n  .Basis-Balloon.visible,\n  .Basis-Balloon.hidden-anim,\n  .Basis-Balloon.hidden\n  {\n\n  }\n\n  .Basis-Balloon-Canvas\n  {\n    pointer-events: none;\n    position: absolute;\n\n    bottom: 0;\n    top: 0;\n    right: 0;\n    left: 0;\n\n    padding-bottom: 10px; /* 5 (top) + 5 (bottom) */\n  }\n\n  .Basis-Balloon-Canvas *\n  {\n    border-color: #E5B720;\n    border-style: solid;\n    border-width: 0;\n  }\n\n  .Basis-Balloon-Canvas .corner-left-top,\n  .Basis-Balloon-Canvas .corner-right-top,\n  .Basis-Balloon-Canvas .corner-left-bottom,\n  .Basis-Balloon-Canvas .corner-right-bottom\n  {\n    background-repeat: no-repeat;\n    background-image: url(data:image/png;base64,);\n  }\n\n  .Basis-Balloon-Canvas .tail\n  {\n    background-repeat: no-repeat;\n    background-image: url(data:image/png;base64,);\n    position: absolute;\n    display: block;\n  }\n\n  .Basis-Balloon-Canvas .side-top,\n  .Basis-Balloon-Canvas .side-bottom\n  {\n    background-repeat: repeat-x;\n    background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAPElEQVR42mJkYGBgYiACsAAxK7EKOYhSuGrVKgOiFF65ckWMGIWMQKxKrBu/EKvwG7FWsxOrkKgABwgwADscBwQE74deAAAAAElFTkSuQmCC);\n  }\n\n  .Basis-Balloon-Canvas .side-left,\n  .Basis-Balloon-Canvas .side-right\n  {\n    background-repeat: repeat-y;\n    background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAMklEQVR42mJmYGBgAmI2IOZZtWqVhaamptnBgwd/A/nsQMzMAAH/mRiIBKMKqaMQIMAAFdsHWGCGydQAAAAASUVORK5CYII=);\n  }\n\n\n  .Basis-Balloon-Canvas .corner-left-top\n  {\n    float: left;\n\n    width: 10px;\n    height: 10px;\n\n    margin-top: -5px;\n    margin-right: -5px;\n    margin-left: -5px;\n\n    background-position: 0 0;\n  }\n  .Basis-Balloon-Canvas .corner-right-top\n  {\n    float: right;\n\n    width: 12px;\n    height: 10px;\n\n    margin-top: -5px;\n    margin-right: -7px;\n    margin-left: -5px;\n\n    background-position: -10px 0;\n  }\n  .Basis-Balloon-Canvas .side-top\n  {\n    margin-right: 5px;\n    margin-left: 5px;\n    margin-top: -5px;\n    height: 4px;\n    border-bottom-width: 1px;\n  }\n\n  .Basis-Balloon-Canvas .side-left\n  {\n    position: relative; /* ? */\n    float: left;\n\n    height: 100%;\n    width: 4px;\n    border-right-width: 1px;\n\n    margin-left: -5px;\n    margin-top: 5px;\n  }\n\n  .Basis-Balloon-Canvas .side-right\n  {\n    position: relative; /* ? */\n    float: right;\n\n    width: 6px;\n    border-left-width: 1px;\n    height: 100%;\n\n    margin-right: -7px;\n    margin-top: 5px;\n\n    background-position: -4px 0;\n  }\n\n  .Basis-Balloon-Canvas .content\n  {\n    height: 100%;\n    padding: 5px 0 5px;\n\n    background-color: #F7E36F;\n  }\n\n  .Basis-Balloon-Canvas .side-bottom\n  {\n    margin-right: 5px;\n    margin-left: 5px;\n\n    height: 6px;\n    border-top-width: 1px;\n\n    background-position: 0 -4px;\n  }\n\n  .Basis-Balloon-Canvas .corner-left-bottom\n  {\n    float: left;\n\n    width: 10px;\n    height: 12px;\n\n    margin-top: -5px;\n    margin-left: -5px;\n\n    background-position: 0 -10px;\n  }\n  .Basis-Balloon-Canvas .corner-right-bottom\n  {\n    float: right;\n\n    width: 12px;\n    height: 12px;\n\n    margin-top: -5px;\n    margin-right: -7px;\n\n    background-position: -10px -10px;\n  }\n\n /*\n  * Content\n  */\n\n  .Basis-Balloon-Layout\n  {\n    position: relative;\n    padding: 3px;\n  }\n\n  .Basis-Balloon-Content\n  {\n    position: relative;\n    background: #FFFAC3;\n    border: 1px solid #F3DD67;\n    padding: 5px;\n    border-radius: 2px;\n      -webkit-border-radius: 2px;\n      -moz-border-radius: 2px;\n  }\n\n  .mode-h-left-top .Basis-Balloon-Content,\n  .mode-h-left-center .Basis-Balloon-Content,\n  .mode-h-left-bottom .Basis-Balloon-Content,\n  .mode-h-right-top .Basis-Balloon-Content,\n  .mode-h-right-center .Basis-Balloon-Content,\n  .mode-h-right-bottom .Basis-Balloon-Content,\n  .mode-v-left-center .Basis-Balloon-Content,\n  .mode-v-right-center .Basis-Balloon-Content\n  {\n    min-height: 24px;\n  }\n\n /**\n  * Modes\n  */\n\n  .mode-v-center-center,\n  .mode-h-center-center\n  {\n  }\n\n /*********************************\n  * TOP BOTTOM\n  */\n\n  .mode-v-left-bottom,\n  .mode-v-right-bottom,\n  .mode-v-center-bottom,\n  .mode-h-center-bottom\n  {\n    margin-bottom: 10px;\n  }\n\n  .mode-h-right-bottom,\n  .mode-h-left-bottom\n  {\n    margin-bottom: -22px;\n  }\n\n  /* ========================== */\n\n  .mode-v-left-top,\n  .mode-v-right-top,\n  .mode-v-center-top,\n  .mode-h-center-top\n  {\n    margin-top: 10px;\n  }\n\n  .mode-h-right-top,\n  .mode-h-left-top\n  {\n    margin-top: -21px;\n  }\n\n  /* ========================== */\n\n  .mode-h-center-bottom .tail,\n  .mode-v-left-bottom .tail,\n  .mode-v-center-bottom .tail,\n  .mode-v-right-bottom .tail\n  {\n    bottom: -16px;\n    height: 16px;\n    width: 30px;\n    background-position: -14px bottom;\n  }\n  .mode-h-center-top .tail,\n  .mode-v-left-top .tail,\n  .mode-v-center-top .tail,\n  .mode-v-right-top .tail\n  {\n    top: -13px;\n    height: 16px;\n    width: 30px;\n    background-position: -14px 0;\n  }\n\n  .mode-v-left-bottom .tail,\n  .mode-v-left-top .tail\n  {\n    left: 6px;\n  }\n  .mode-h-center-bottom .tail,\n  .mode-h-center-top .tail,\n  .mode-v-center-bottom .tail,\n  .mode-v-center-top .tail\n  {\n    left: 50%;\n    margin-left: -15px;\n  }\n  .mode-v-right-bottom .tail,\n  .mode-v-right-top .tail\n  {\n    right: 6px;\n  }\n\n /*******************************\n  *  LEFT RIGHT\n  */\n\n  .mode-v-left-center,\n  .mode-h-left-top,\n  .mode-h-left-center,\n  .mode-h-left-bottom\n  {\n    margin-left: 10px;\n  }\n\n  .mode-v-left-top,\n  .mode-v-left-bottom\n  {\n    margin-left: -22px;\n  }\n\n  .mode-v-right-center,\n  .mode-h-right-center,\n  .mode-h-right-top,\n  .mode-h-right-bottom\n  {\n    margin-right: 10px;\n  }\n\n  .mode-v-right-top,\n  .mode-v-right-bottom\n  {\n    margin-right: -21px;\n  }\n\n  .mode-v-left-center .tail,\n  .mode-h-left-bottom .tail,\n  .mode-h-left-center .tail,\n  .mode-h-left-top .tail\n  {\n    height: 31px;\n    width: 16px;\n    left: -14px;\n    background-position: 0 -13px;\n  }\n\n  .mode-v-right-center .tail,\n  .mode-h-right-bottom .tail,\n  .mode-h-right-center .tail,\n  .mode-h-right-top .tail\n  {\n    height: 31px;\n    width: 16px;\n    right: -16px;\n    background-position: right -13px;\n  }\n\n  .mode-h-left-top .tail,\n  .mode-h-right-top .tail\n  {\n    top: 5px;\n  }\n  .mode-v-left-center .tail,\n  .mode-v-right-center .tail,\n  .mode-h-left-center .tail,\n  .mode-h-right-center .tail\n  {\n    top: 50%;\n    margin-top: -15px;\n  }\n  .mode-h-left-bottom .tail,\n  .mode-h-right-bottom .tail\n  {\n    bottom: 6px;\n  }\n\n/*@import url(/node_modules/basisjs/src/basis/ui/templates/popup/popupManager.css);*/\n\n  \n  #Basis-PopupStack.hasChildren\n  {\n  }\n\n/*@import url(/src/backbone/template/inspectMode.css);*/\n\n.tpwo1b2513sngndw__x14ftwem316m8zlg__label\n{\n  border-radius: 3px;\n  background: orange;\n  padding: 6px;\n  margin: 3px -1px -1px;\n}\n\n/*@import url(/src/backbone/template/reloadRequired.css);*/\n\n.tpwo1b2513sngndw__v147rkpezkpd5lh8__label\n{\n  border-radius: 3px;\n  background: orange;\n  padding: 6px;\n  margin: 3px -1px -1px;\n}\n\n/*@import url(/src/backbone/template/panel.css);*/\n\n.tpwo1b2513sngndw__panel\n{\n  position: fixed;\n  z-index: 10001;\n  left: 10px;\n  top: 10px;\n  padding: 1px;\n\n  opacity: 0.5;\n  background: #999;\n  border-radius: 3px;\n  box-shadow:\n    0 0 7px 1px rgba(0, 0, 0, 0),\n    0 0 0px 1px rgba(255, 255, 255, .75);\n  \n  font-family: Arial;\n  font-size: 12px;\n  line-height: normal;\n  color: white;\n  text-align: center;\n  \n  cursor: pointer;\n\n  transition: box-shadow .15s, background .15s, opacity .15s, border-color .15s;\n}\n.tpwo1b2513sngndw__panel,\n.tpwo1b2513sngndw__panel *\n{\n  -moz-box-sizing: content-box;\n  box-sizing: content-box;\n}\n\n@media print {\n  .tpwo1b2513sngndw__panel\n  {\n    display: none;\n  }\n}\n\n.tpwo1b2513sngndw__panel:hover,\n.tpwo1b2513sngndw__panel_activated\n{\n  opacity: .999999;\n  box-shadow:\n    0 0 7px 1px rgba(0, 0, 0, .3),\n    0 0 0px 1px rgba(255, 255, 255, 1);\n}\n\n.tpwo1b2513sngndw__panel_isOnline\n{\n  background: #4B77CC;\n}\n\n.tpwo1b2513sngndw__panel__section\n{\n  position: relative;\n  display: inline-block;\n}\n\n.tpwo1b2513sngndw__panel__button\n{\n  border-left: 1px solid rgba(255, 255, 255, .4);\n  display: inline-block;\n  padding: 5px 8px;\n  min-width: 10px;\n  background: no-repeat center center;\n}\n.tpwo1b2513sngndw__panel__button:hover,\n.tpwo1b2513sngndw__panel__button_active-template\n{\n  background-color: rgba(255, 255, 255, 0.2);\n}\n.tpwo1b2513sngndw__panel__section:last-child .tpwo1b2513sngndw__panel__button\n{\n  border-right: none;\n  border-radius: 0 4px 4px 0;\n}\n\n.tpwo1b2513sngndw__panel__button_template\n{\n  background-image: url(data:image/png;base64,); \n}\n\n.tpwo1b2513sngndw__panel__dd-trigger\n{\n  display: inline-block;\n  position: relative;\n  top: 0px;\n  width: 12px;\n  height: 100%;\n  cursor: move;\n  background: url(data:image/png;base64,) no-repeat center;\n}\n\n.tpwo1b2513sngndw__info-panels\n{\n  position: absolute;\n  left: 100%;\n  margin-left: 3px;\n  top: -3px;\n  width: 200px;\n}\n\n/*@import url(/src/backbone/inspector/template-info/template/js-source-popup.css);*/\n\n.uvk07v9ibg2ian7n__balloon\n{\n  position: absolute;\n  margin-top: 6px;\n  padding: 8px 16px 8px 10px;\n  min-height: 1em;\n  min-width: 300px;\n  background-color: white;\n  background-color: rgba(255, 255, 255, .95);\n  border: 1px solid #e6e9ed;\n  border-radius: 2px;\n  box-shadow: 0 0 6px rgba(46, 53, 62, .11);\n  pointer-events: none;\n  font-family: Tahoma, Verdana, Arial, sans-serif;\n}\n.uvk07v9ibg2ian7n__tail\n{\n  position: absolute;\n  width: 15px;\n  height: 6px;\n  overflow: hidden;\n}\n.uvk07v9ibg2ian7n__tail:after\n{\n  content: \'\';\n  display: block;\n  width: 9px;\n  height: 9px;\n  margin: 0 auto;\n  -webkit-transform: translateX(5px) rotate(45deg);\n  transform: translateX(5px) rotate(45deg);\n  -webkit-transform-origin: left top;\n  transform-origin: left top;\n  background-color: white;\n  border: 1px solid #e6e9ed;\n  box-shadow: 1px 1px 6px rgba(46, 53, 62, .11);\n}\n.uvk07v9ibg2ian7n__tail_v-left-bottom:after,\n.uvk07v9ibg2ian7n__tail_v-center-bottom:after,\n.uvk07v9ibg2ian7n__tail_v-right-bottom:after\n{\n  position: absolute;\n  bottom: 7px;\n  -webkit-transform: translateX(8px) rotate(45deg);\n  transform: translateX(8px) rotate(45deg);\n}\n\n.uvk07v9ibg2ian7n__balloon_v-left-top,\n.uvk07v9ibg2ian7n__balloon_v-left-bottom\n{\n  margin-left: -38px;\n}\n.uvk07v9ibg2ian7n__balloon_v-left-bottom\n{\n  margin-bottom: 5px;\n}\n.uvk07v9ibg2ian7n__balloon_v-right-top,\n.uvk07v9ibg2ian7n__balloon_v-right-bottom\n{\n  margin-right: -13px;\n}\n.uvk07v9ibg2ian7n__balloon_v-center-top,\n.uvk07v9ibg2ian7n__balloon_v-center-bottom\n{\n  /* todo? */\n}\n\n.uvk07v9ibg2ian7n__tail_v-center-top,\n.uvk07v9ibg2ian7n__tail_v-center-bottom\n{\n  left: 50%;\n  margin-left: -7px;\n}\n.uvk07v9ibg2ian7n__tail_v-left-top,\n.uvk07v9ibg2ian7n__tail_v-left-bottom\n{\n  left: 36px;\n}\n.uvk07v9ibg2ian7n__tail_v-right-top,\n.uvk07v9ibg2ian7n__tail_v-right-bottom\n{\n  right: 12px;\n  margin-right: -7px;\n}\n\n.uvk07v9ibg2ian7n__tail_v-left-top,\n.uvk07v9ibg2ian7n__tail_v-center-top,\n.uvk07v9ibg2ian7n__tail_v-right-top\n{\n  top: -6px;\n}\n.uvk07v9ibg2ian7n__tail_v-left-bottom,\n.uvk07v9ibg2ian7n__tail_v-center-bottom,\n.uvk07v9ibg2ian7n__tail_v-right-bottom\n{\n  bottom: -8px;\n  width: 20px;\n  height: 8px;\n}\n\n.uvk07v9ibg2ian7n__header\n{\n  padding-left: 6px;\n  padding-bottom: 8px;\n  margin-right: -8px;\n  font-size: 11px;\n  color: #666;\n  text-align: center;\n}\n.uvk07v9ibg2ian7n__header__comment\n{\n  display: block;\n  padding-top: 2px;\n  font-size: 10px;\n  color: #999;\n}\n\n.uvk07v9ibg2ian7n__source\n{\n  margin: 0;\n  padding: 0;\n  font-family: Consolas, Monaco, monospace;\n  font-size: 12px;\n  line-height: 16px;\n}\n.uvk07v9ibg2ian7n__source [class~="line"]\n{\n  max-width: 600px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.uvk07v9ibg2ian7n__source [class~="num"]\n{\n  color: #BBB;\n  margin-right: 2px;\n}\n.uvk07v9ibg2ian7n__source [class~="line"]:first-child [class~="num"],\n.uvk07v9ibg2ian7n__source [class~="skip-before"] + [class~="line"] [class~="num"]\n{\n  margin-right: 6px;\n}\n.uvk07v9ibg2ian7n__source [class~="range"]\n{\n  background: #F8F0D0;\n  padding: 2px 4px 2px 4px;\n}\n.uvk07v9ibg2ian7n__source [class~="line"]:first-child [class~="range"],\n.uvk07v9ibg2ian7n__source [class~="skip-before"] + [class~="line"] [class~="range"]\n{\n  padding-left: 2px;\n  margin-left: -2px;\n}\n.uvk07v9ibg2ian7n__source [class~="skip-before"],\n.uvk07v9ibg2ian7n__source [class~="skip-after"]\n{\n  color: #CCC;\n}\n\n.uvk07v9ibg2ian7n__source [class~="token-string"]\n{\n  color: blue;\n}\n.uvk07v9ibg2ian7n__source [class~="token-comment"]\n{\n  color: #008200;\n}\n.uvk07v9ibg2ian7n__source [class~="token-keyword"]\n{\n  color: #006699;\n  font-weight: bold;\n}\n.uvk07v9ibg2ian7n__source [class~="token-key"]\n{\n  color: #006699;\n}\n.uvk07v9ibg2ian7n__source [class~="token-value"]\n{\n  color: #AA8844;\n  font-weight: bold;\n}\n\n/*@import url(/src/backbone/inspector/template-info/template/tree/attribute-value.css);*/\n\n.cpg9vv0t13nlxht1__binding\n{\n  padding: 3px;\n  padding: 3px .5ch;\n  margin: 0 1px;\n  border-radius: 2px;\n  color: #666;\n  background: #EEE;\n  text-shadow: 0px 0px 1px white;\n  transition: color .15s, background-color .15s;\n  cursor: default;\n}\n.cpg9vv0t13nlxht1__matchBinding\n{\n  color: #353;\n  background: #B6CFB6;\n}\n.cpg9vv0t13nlxht1__action,\n.cpg9vv0t13nlxht1__l10n\n{\n  padding: 3px;\n  padding: 3px .5ch;\n  margin: 0 1px;\n  border-radius: 2px;\n  background: #ADCCEB;\n  color: #458;\n  text-shadow: 0px 0px 1px white;\n  cursor: default;\n}\n.cpg9vv0t13nlxht1__l10n\n{\n  background: #EAC4F7;\n  color: #661188;\n}\n.cpg9vv0t13nlxht1__hasLocation\n{\n  text-decoration: underline;\n  cursor: pointer;\n}\n\n/*@import url(/src/backbone/inspector/template-info/template/tree/attritube.css);*/\n\n.k19xppuqu8ju9l8i__attribute\n{\n}\n.k19xppuqu8ju9l8i__name\n{\n  white-space: nowrap;\n  color: rgb(153, 69, 0);\n}\n.k19xppuqu8ju9l8i__value\n{\n  color: rgb(26, 26, 166);\n}\n\n/*@import url(/src/backbone/inspector/template-info/template/tree/element.css);*/\n\n.x5fgoirx2a458qp6__element\n{\n  color: rgb(136, 18, 128);\n}\n.x5fgoirx2a458qp6__childNodes\n{\n  padding-left: 2ex;\n  padding-left: 2ch;\n}\n.x5fgoirx2a458qp6__inline\n{\n  padding: 0 2px;\n  display: inline-block;\n}\n.x5fgoirx2a458qp6__childrenHidden\n{\n  color: #666;\n  padding: 0 1px;\n}\n.x5fgoirx2a458qp6__binding,\n.x5fgoirx2a458qp6__nestedView\n{\n  padding: 3px;\n  padding: 3px .5ch;\n  margin-left: -3px;\n  margin-left: -.5ch;\n  border-radius: 2px;\n  background: #EEE;\n  text-shadow: 0px 0px 1px white;\n  transition: color .15s, background-color .15s;\n}\n.x5fgoirx2a458qp6__nestedView:not(.x5fgoirx2a458qp6__binding),\n.x5fgoirx2a458qp6__matchBinding.x5fgoirx2a458qp6__nestedView\n{\n  background: #E0E4B0;\n}\n.x5fgoirx2a458qp6__matchBinding\n{\n  background: #B6CFB6;\n}\n.x5fgoirx2a458qp6__nestedView\n{\n  cursor: pointer;\n}\n\n/*@import url(/src/backbone/inspector/template-info/template/tree/element_text.css);*/\n\n.ypdebaaekzvhfkif__inline .ypdebaaekzvhfkif__text\n{\n  margin-left: 0;\n}\n\n/*@import url(/src/backbone/inspector/template-info/template/tree/text.css);*/\n\n.p160cu8pz4w3hckq__text\n{\n  color: rgb(48, 57, 66);\n}\n.p160cu8pz4w3hckq__binding,\n.p160cu8pz4w3hckq__nestedView,\n.p160cu8pz4w3hckq__l10n\n{\n  padding: 3px;\n  padding: 3px .65ch;\n  margin-left: -3px;\n  margin-left: -.5ch;\n  border-radius: 2px;\n  background: #EEE;\n  color: #666;\n  text-shadow: 0px 0px 1px white;  \n  transition: color .15s, background-color .15s;\n  cursor: default;\n}\n.p160cu8pz4w3hckq__nestedView:not(.p160cu8pz4w3hckq__binding),\n.p160cu8pz4w3hckq__matchBinding.p160cu8pz4w3hckq__nestedView\n{\n  background: #E0E4B0;\n}\n.p160cu8pz4w3hckq__matchBinding\n{\n  background: #B6CFB6;\n}\n.p160cu8pz4w3hckq__matchBinding\n{\n  background: #B6CFB6;\n  color: #353;\n}\n.p160cu8pz4w3hckq__l10n\n{\n  background: #EAC4F7;\n  color: #661188;\n}\n.p160cu8pz4w3hckq__nestedView\n{\n  cursor: pointer;\n}\n\n/*@import url(/src/backbone/inspector/template-info/template/tree/comment.css);*/\n\n.c11469ax610bozee__comment\n{\n  color: rgb(35, 110, 37);\n}\n.c11469ax610bozee__binding,\n.c11469ax610bozee__nestedView\n{\n  padding: 3px;\n  padding: 3px .5ch;\n  margin-left: -3px;\n  margin-left: -.5ch;\n  border-radius: 2px;\n  color: #666;\n  background: #EEE;\n  text-shadow: 0px 0px 1px white;\n  transition: color .15s, background-color .15s;\n}\n.c11469ax610bozee__nestedView:not(.c11469ax610bozee__binding),\n.c11469ax610bozee__matchBinding.c11469ax610bozee__nestedView\n{\n  background: #E0E4B0;\n}\n.c11469ax610bozee__matchBinding\n{\n  color: #353;\n  background: #B6CFB6;\n}\n.c11469ax610bozee__nestedView\n{\n  cursor: pointer;\n}\n\n/*@import url(/src/backbone/inspector/template-info/template/object-info.css);*/\n\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__panel\n{\n  padding-top: 4px;\n}\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__caption\n{\n  font-size: 10px;\n  color: #888;\n}\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__content\n{\n  padding: 6px 4px 8px;\n}\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__object-title\n{\n  font-size: 12px;\n}\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__object-loc\n{\n  padding-top: 4px;\n  display: block;\n  font-size: 11px;\n  color: #AAA;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  overflow: hidden;\n}\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__loc\n{\n  color: #888;\n  cursor: pointer;\n  text-decoration: underline;\n}\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__loc:hover\n{\n  color: #A00;\n}\n\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__instance:before,\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__class:before,\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__render:before\n{\n  border-radius: 2px;\n  padding: 0px 4px;\n  margin-right: 1ex;\n  width: 1.5ex;\n  display: inline-block;\n  text-align: center;\n}\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__instance:before\n{\n  content: "I";\n  color: #353;\n  background: #B6CFB6;\n}\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__class:before\n{\n  content: "C";\n  color: #618;\n  background: #EAC4F7;\n}\n.uuxl2qkw32qj2pro__oqnyv9f9vofawp46__render:before\n{\n  content: "R";\n  color: #458;\n  background: #ADCCEB;\n}\n\n/*@import url(/src/backbone/inspector/template-info/template/window.css);*/\n\n.uuxl2qkw32qj2pro__window__wrapper\n{\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  margin: 0;\n  padding: 40px 0;\n  text-align: center;\n  white-space: nowrap;\n  z-index: 10001;\n  transform: translateZ(0);\n  background: rgba(0, 0, 0, .2);\n  overflow: auto;\n}\n.uuxl2qkw32qj2pro__window__wrapper:before\n{\n  content: \'\';\n  display: inline-block;\n  height: 100%;\n  vertical-align: middle;\n}\n.uuxl2qkw32qj2pro__window\n{\n  /* vertical center */\n  position: relative;\n  display: inline-block;\n  vertical-align: middle;\n}\n.uuxl2qkw32qj2pro__window__inner-wrapper\n{\n  overflow: auto;\n  padding: 4px 8px;\n  background: white;\n  background: rgba(255, 255, 255, .95);\n  border-radius: 2px;\n  box-shadow: 1px 1px 4px 1px rgba(0, 0, 0, .3);\n  display: flex;\n}\n.uuxl2qkw32qj2pro__window__inner\n{\n  text-align: left;\n  font-size: 12px;\n  font-family: Tahoma, Verdana, Arial, sans-serif;\n}\n\n.uuxl2qkw32qj2pro__source-toggle-button\n{\n  background: #EEE;\n  margin-top: 8px;\n  padding: 6px;\n  border-radius: 2px;\n  opacity: .8;\n  cursor: pointer;\n}\n.uuxl2qkw32qj2pro__source-toggle-button:hover\n{\n  opacity: 1;\n}\n\n.uuxl2qkw32qj2pro__content\n{\n  vertical-align: top;\n  min-width: 300px;\n  max-width: 650px;\n  padding: 0;\n}\n.uuxl2qkw32qj2pro__toolbar\n{\n  padding-bottom: 1px;\n}\n.uuxl2qkw32qj2pro__source-title\n{\n  font-size: 12px;\n  padding: 3px 3ex;\n  margin-right: 60px;\n  text-align: center;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  color: #666;\n}\n.uuxl2qkw32qj2pro__source-title_isFile\n{\n  cursor: pointer;\n  text-decoration: underline;\n}\n.uuxl2qkw32qj2pro__source-title_isFile:hover\n{\n  color: #A00;\n}\n.uuxl2qkw32qj2pro__button\n{\n  background: #EEE;\n  padding: 3px 8px;\n  line-height: 1.2;\n  font-size: 12px;\n}\n.uuxl2qkw32qj2pro__button_up\n{\n  position: relative;\n  left: -3px;\n  padding-left: 6px;\n  display: inline-block;\n  visibility: hidden;\n  cursor: pointer;\n  float: left;\n}\n.uuxl2qkw32qj2pro__button_up.uuxl2qkw32qj2pro__button_upName\n{\n  visibility: visible;\n}\n.uuxl2qkw32qj2pro__button_up:hover\n{\n  background: #DDD;\n}\n.uuxl2qkw32qj2pro__button_source\n{\n  float: right;\n  margin-right: -5px;\n  border-radius: 10px;\n}\n.uuxl2qkw32qj2pro__code\n{\n  padding: 4px 0 2px;\n  clear: both;\n  overflow: hidden;\n  white-space: pre-wrap;\n  color: #444;\n  font-family: Consolas, Monaco, Courier New, monospace;\n  font-size: 12px;\n  line-height: 22px;  \n}\n.uuxl2qkw32qj2pro__binding\n{\n  background: rgb(182, 207, 182);\n  padding: 3px;\n}\n\n.uuxl2qkw32qj2pro__sidebar\n{\n  vertical-align: top;\n  max-width: 300px;\n  border-right: 1px solid #EEE;\n  margin-right: 10px;\n  padding-right: 10px;\n  white-space: normal;\n}\n\n.uuxl2qkw32qj2pro__info-links\n{\n}\n.uuxl2qkw32qj2pro__log__link\n{\n  float: right;\n  color: red;\n  margin-left: 1ex;\n  padding-top: 0px;\n  text-decoration: underline;\n  color: #666;\n  cursor: pointer;\n}\n.uuxl2qkw32qj2pro__log__link:hover\n{\n  color: #A00;\n}\n\n/*@import url(/src/backbone/inspector/template/template_hintPopup.css);*/\n\n.p3ndiojqw25xgf81__popup\n{\n  position: absolute;\n  padding: 4px 8px;\n  margin: 2px 0;\n  border: 1px solid #D0C0AA;\n  border: 1px solid rgba(0, 0, 0, .4);\n  background: white;\n  background: rgba(255, 255, 255, .95);\n  background-image: linear-gradient(to bottom, rgba(255, 255, 255, .5) 0%, rgba(128, 128, 128, .15) 100%);\n  pointer-events: none;\n  font-size: 11px;\n  font-family: Tahoma, Verdana, Arial, sans-serif;\n  line-height: 1.5;\n  transition: all .05s;\n  z-index: 10001 !important;\n  box-shadow: 1px 1px 3px rgba(0, 0, 0, .25);\n}\n\n.p3ndiojqw25xgf81__section\n{\n\n}\n\n.p3ndiojqw25xgf81__section__title\n{\n  font-size: 11px;\n  color: #666;\n}\n.p3ndiojqw25xgf81__section__title-text\n{\n  border-bottom: 2px solid #C8D0D8;\n}\n.p3ndiojqw25xgf81__section__content\n{\n  padding: 5px 5px 10px 15px;\n}\n.p3ndiojqw25xgf81__name\n{\n  font-size: 14px;\n  color: #28A;\n}\n.p3ndiojqw25xgf81__source\n{\n  color: #888;\n  font-size: 11px;\n  display: block;\n  padding-top: 4px;\n  margin-bottom: -1px;\n}\n.p3ndiojqw25xgf81__location\n{\n  color: #282;\n}\n.p3ndiojqw25xgf81__ui-hint\n{\n  display: block;\n  color: #AAA;\n  font-size: 10px;\n}\n\n.p3ndiojqw25xgf81__satelliteName\n{\n  padding: 1px 5px 2px;\n  margin: 0 1ex 0 -2px;\n  color: #666;\n  background: #9C0;\n  border-radius: 3px;\n  font-size: 11px;\n}\n.p3ndiojqw25xgf81__satelliteName_equalNames\n{\n  background-image: linear-gradient(to bottom, transparent 55%, #D4D490 55%);\n}\n.p3ndiojqw25xgf81__role\n{\n  padding: 1px 5px 2px;\n  margin: 0 1ex 0 -2px;\n  color: #666;\n  background: #D4D490;\n  border-radius: 3px;\n  font-size: 11px;\n}\n\n.p3ndiojqw25xgf81__namespace\n{\n  color: #888;\n  font-size: 10px;\n}\n.p3ndiojqw25xgf81__id\n{\n  color: #888;\n  padding-left: 1ex;\n}\n\n',
  "3.tmpl": [ [ 1, 0, [ "element" ], "div", [ 4, [ [ "tpwo1b2513sngndw__panel_", "activated", 2, "activated", 0 ], [ "tpwo1b2513sngndw__panel_", "isOnline", 2, "isOnline", 0 ], [ "tpwo1b2513sngndw__panel_", "inspectMode", 2, "inspectMode", 0 ] ], 0, "tpwo1b2513sngndw__panel" ], [ 2, 0, 0, "basis-devpanel-ignore" ], [ 6, "mousemove", "storePosition" ], [ 1, 1, [ "dragElement" ], "div", [ 4, 0, 0, "tpwo1b2513sngndw__panel__dd-trigger" ], [ 3, 0, 0, " " ] ], [ 1, 0, 0, "div", [ 4, 0, 0, "tpwo1b2513sngndw__panel__section" ], [ 1, 0, 0, "div", [ 4, [ [ "tpwo1b2513sngndw__panel__button_active-", "inspectorId", 1, "templateActivated", 0, [ "template" ] ] ], 0, "tpwo1b2513sngndw__panel__button tpwo1b2513sngndw__panel__button_template" ], [ 6, "mousedown", "inspectTemplate" ], [ 3, 0, 0, " " ] ] ], [ 1, 0, 0, "div", [ 4, 0, 0, "tpwo1b2513sngndw__info-panels" ], [ 1, 0, 0, "div", [ 4, 0, 0, "tpwo1b2513sngndw__v147rkpezkpd5lh8__label" ], [ 6, "click", "reload" ], [ 5, [ [ [ "permanentFilesChangedCount" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 3, 1, [ "permanentFilesChangedCount" ] ], [ 3, 0, 0, " " ], [ 3, "l10n:file.{permanentFilesChangedCount}@0.l10n", 0 ], [ 3, 0, 0, " updated, changes can't be applied until page reload" ] ], [ 1, 0, 0, "div", [ 4, 0, 0, "tpwo1b2513sngndw__x14ftwem316m8zlg__label" ], [ 6, "click", "cancelInspect" ], [ 5, [ [ [ "inspector" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 3, 1, [ "inspector" ] ], [ 3, 0, 0, " inspector is activated" ] ] ] ] ],
  "d.tmpl": [ [ 1, 0, [ "element" ], "div", [ 4, 0, 0, "p3ndiojqw25xgf81__popup" ], [ 1, 0, 0, "div", [ 4, 0, 0, "p3ndiojqw25xgf81__section" ], [ 1, 0, 0, "div", [ 4, 0, 0, "p3ndiojqw25xgf81__section__title" ], [ 1, 0, 0, "span", [ 4, 0, 0, "p3ndiojqw25xgf81__section__title-text" ], [ 3, 0, 0, "View" ] ] ], [ 1, 0, 0, "div", [ 4, 0, 0, "p3ndiojqw25xgf81__section__content" ], [ 1, 0, 0, "span", [ 4, 0, 0, "p3ndiojqw25xgf81__name" ], [ 3, 0, 0, "#" ], [ 3, 1, [ "instanceId" ] ] ], [ 1, 0, 0, "span", [ 5, [ [ [ "instanceLocation" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, 0, "span", [ 4, 0, 0, "p3ndiojqw25xgf81__source" ], [ 3, 0, 0, "Created at " ], [ 1, 0, 0, "span", [ 4, 0, 0, "p3ndiojqw25xgf81__location" ], [ 3, 1, [ "instanceLocation" ] ] ] ], [ 1, 0, 0, "span", [ 4, 0, 0, "p3ndiojqw25xgf81__ui-hint" ], [ 5, [ [ [ "openFileSupported" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 3, 0, 0, "Use alt + click to open place in editor" ] ] ] ] ] ] ],
  "c.tmpl": [ [ 1, 0, [ "element" ], "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__window__wrapper" ], [ 6, "click", "close" ], [ 6, "mousedown", "stop-propagation prevent-default" ], [ 2, 0, 0, "basis-devpanel-ignore" ], [ 5, [ [ [ "visible" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, [ "ddelement", "ddtrigger" ], "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__window" ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__window__inner" ], [ 6, "click", "stop-propagation" ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__window__inner-wrapper" ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__sidebar" ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__info-links" ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__log__link" ], [ 6, "click", "logInfo" ], [ 2, 0, 0, "title", "Output view in console save it as $backboneView" ], [ 3, 0, 0, "console.log(info)" ] ] ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__panel" ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__caption" ], [ 3, 0, 0, "View" ] ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__content" ], [ 8, 0, 0, ' <span class="object-title">#{objectId}</span> ' ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__object-loc uuxl2qkw32qj2pro__oqnyv9f9vofawp46__instance" ], [ 5, [ [ [ "objectLoc" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__loc" ], [ 2, [ [ "objectLoc" ], [ 0 ] ], 0, "data-loc", "{objectLoc}" ], [ 6, "click", "openRefLocation" ], [ 6, "mouseenter", "enterRefLocation" ], [ 6, "mouseleave", "leaveRefLocation" ], [ 3, 1, [ "objectLoc" ] ] ] ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__object-loc uuxl2qkw32qj2pro__oqnyv9f9vofawp46__class" ], [ 5, [ [ [ "objectClassLoc" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__loc" ], [ 2, [ [ "objectClassLoc" ], [ 0 ] ], 0, "data-loc", "{objectClassLoc}" ], [ 6, "click", "openRefLocation" ], [ 6, "mouseenter", "enterRefLocation" ], [ 6, "mouseleave", "leaveRefLocation" ], [ 3, 1, [ "objectClassLoc" ] ] ] ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__object-loc uuxl2qkw32qj2pro__oqnyv9f9vofawp46__render" ], [ 5, [ [ [ "objectRenderLoc" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__loc" ], [ 2, [ [ "objectRenderLoc" ], [ 0 ] ], 0, "data-loc", "{objectRenderLoc}" ], [ 6, "click", "openRefLocation" ], [ 6, "mouseenter", "enterRefLocation" ], [ 6, "mouseleave", "leaveRefLocation" ], [ 3, 1, [ "objectRenderLoc" ] ] ] ] ], [ 1, 0, 0, "div", [ 5, [ [ [ "collectionLoc" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__caption" ], [ 3, 0, 0, "Collection" ] ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__content" ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__object-loc uuxl2qkw32qj2pro__oqnyv9f9vofawp46__instance" ], [ 5, [ [ [ "collectionLoc" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__loc" ], [ 2, [ [ "collectionLoc" ], [ 0 ] ], 0, "data-loc", "{collectionLoc}" ], [ 6, "click", "openRefLocation" ], [ 6, "mouseenter", "enterRefLocation" ], [ 6, "mouseleave", "leaveRefLocation" ], [ 3, 1, [ "collectionLoc" ] ] ] ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__object-loc uuxl2qkw32qj2pro__oqnyv9f9vofawp46__class" ], [ 5, [ [ [ "collectionClassLoc" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__loc" ], [ 2, [ [ "collectionClassLoc" ], [ 0 ] ], 0, "data-loc", "{collectionClassLoc}" ], [ 6, "click", "openRefLocation" ], [ 6, "mouseenter", "enterRefLocation" ], [ 6, "mouseleave", "leaveRefLocation" ], [ 3, 1, [ "collectionClassLoc" ] ] ] ] ] ], [ 1, 0, 0, "div", [ 5, [ [ [ "modelLoc" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__caption" ], [ 3, 0, 0, "Model" ] ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__content" ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__object-loc uuxl2qkw32qj2pro__oqnyv9f9vofawp46__instance" ], [ 5, [ [ [ "modelLoc" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__loc" ], [ 2, [ [ "modelLoc" ], [ 0 ] ], 0, "data-loc", "{modelLoc}" ], [ 6, "click", "openRefLocation" ], [ 6, "mouseenter", "enterRefLocation" ], [ 6, "mouseleave", "leaveRefLocation" ], [ 3, 1, [ "modelLoc" ] ] ] ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__object-loc uuxl2qkw32qj2pro__oqnyv9f9vofawp46__class" ], [ 5, [ [ [ "modelClassLoc" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 1, 0, 0, "span", [ 4, 0, 0, "uuxl2qkw32qj2pro__oqnyv9f9vofawp46__loc" ], [ 2, [ [ "modelClassLoc" ], [ 0 ] ], 0, "data-loc", "{modelClassLoc}" ], [ 6, "click", "openRefLocation" ], [ 6, "mouseenter", "enterRefLocation" ], [ 6, "mouseleave", "leaveRefLocation" ], [ 3, 1, [ "modelClassLoc" ] ] ] ] ] ] ] ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__content" ], [ 1, 0, 0, "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__toolbar" ], [ 1, 0, 0, "span", [ 4, [ [ "uuxl2qkw32qj2pro__button_", "upName", 2, "upName", 0 ] ], 0, "uuxl2qkw32qj2pro__button uuxl2qkw32qj2pro__button_up" ], [ 5, 0, 0, "margin-left: -3px;" ], [ 6, "click", "up" ], [ 3, 0, 0, "↑ " ], [ 3, 1, [ "upName" ] ] ], [ 8, 0, 0, ' <span class="button button_source">source</span> ' ], [ 1, 0, 0, "div", [ 4, [ [ "uuxl2qkw32qj2pro__source-title_", "isFile", 0 ] ], 0, "uuxl2qkw32qj2pro__source-title" ], [ 6, "click", "openSource" ], [ 2, [ [ "sourceTitle" ], [ 0 ] ], 0, "title", "{sourceTitle}" ], [ 3, 1, [ "sourceTitle" ] ] ] ], [ 1, 1, [ "childNodesElement" ], "div", [ 4, 0, 0, "uuxl2qkw32qj2pro__code" ] ] ] ] ] ] ] ],
  "b.tmpl": [ [ 1, 0, [ "element" ], "div", [ 4, 0, 0, "c11469ax610bozee__comment" ], [ 1, 0, 0, "span", [ 4, [ [ "c11469ax610bozee__", "binding", 2, "binding", 0 ], [ "c11469ax610bozee__", "matchBinding", 2, "matchBinding", 0 ], [ "c11469ax610bozee__", "nestedView", 2, "nestedView", 0 ] ], 0, "c11469ax610bozee__caption" ], [ 6, "click", "inspect" ], [ 6, "mouseenter", "enter" ], [ 6, "mouseleave", "leave" ], [ 3, 0, 0, "<!--" ], [ 3, 1, [ "value" ] ], [ 3, 0, 0, "-->" ] ] ] ],
  "a.tmpl": [ [ 1, 0, [ "element" ], "span", [ 4, [ [ "p160cu8pz4w3hckq__", "binding", 2, "binding", 0 ], [ "p160cu8pz4w3hckq__", "matchBinding", 2, "matchBinding", 0 ], [ "p160cu8pz4w3hckq__", "nestedView", 2, "nestedView", 0 ], [ "p160cu8pz4w3hckq__", "l10n", 2, "l10n", 0 ] ], 0, "p160cu8pz4w3hckq__text ypdebaaekzvhfkif__text" ], [ 6, "click", "inspect" ], [ 6, "mouseenter", "enter" ], [ 6, "mouseleave", "leave" ], [ 3, 1, [ "value" ] ] ] ],
  "9.tmpl": [ [ 1, 0, [ "element" ], "span" ] ],
  "8.tmpl": [ [ 1, 0, [ "element" ], "div", [ 4, 0, 0, "x5fgoirx2a458qp6__element" ], [ 1, 0, 0, "span", [ 4, [ [ "x5fgoirx2a458qp6__", "binding", 2, "binding", 0 ], [ "x5fgoirx2a458qp6__", "matchBinding", 2, "matchBinding", 0 ], [ "x5fgoirx2a458qp6__", "nestedView", 2, "nestedView", 0 ] ], 0 ], [ 6, "click", "inspect" ], [ 6, "mouseenter", "enter" ], [ 6, "mouseleave", "leave" ], [ 3, 0, 0, "<" ], [ 3, "name", 0 ], [ 8, 1, [ "attributes" ] ], [ 3, 0, 0, ">" ], [ 1, 0, 0, "span", [ 5, [ [ [ "singleton" ], [ 0 ], "display", "hide" ] ], 0, null ], [ 1, 1, [ "childNodesElement" ], "div", [ 4, [ [ "x5fgoirx2a458qp6__", "inline", 2, "inline", 0 ], [ "ypdebaaekzvhfkif__", "inline", 2, "inline", 0 ] ], 0, "x5fgoirx2a458qp6__childNodes" ], [ 5, [ [ [ "childCount" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ] ], [ 1, 0, 0, "span", [ 4, 0, 0, "x5fgoirx2a458qp6__childrenHidden" ], [ 5, [ [ [ "childrenHidden" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 3, 0, 0, "…" ] ], [ 3, 0, 0, "</" ], [ 3, 1, [ "name" ] ], [ 3, 0, 0, ">" ] ] ] ] ],
  "7.tmpl": [ [ 1, 0, [ "element" ], "span", [ 4, 0, 0, "k19xppuqu8ju9l8i__attribute" ], [ 3, 0, 0, " " ], [ 1, 0, 0, "span", [ 4, 0, 0, "k19xppuqu8ju9l8i__name" ], [ 3, 1, [ "name" ] ] ], [ 1, 0, 0, "span", [ 5, [ [ [ "childCount" ], [ 0 ], "display", "show" ] ], 0, "display: none;" ], [ 3, 0, 0, '="' ], [ 1, 1, [ "childNodesElement" ], "span", [ 4, 0, 0, "k19xppuqu8ju9l8i__value" ] ], [ 3, 0, 0, '"' ] ] ] ],
  "6.tmpl": [ [ 1, 0, [ "element" ], "span", [ 4, [ [ "cpg9vv0t13nlxht1__", "type", 1, "type", 0, [ "binding", "action", "l10n" ] ], [ "cpg9vv0t13nlxht1__", "matchBinding", 2, "matchBinding", 0 ], [ "cpg9vv0t13nlxht1__", "loc", 2, "hasLocation", 0 ] ], 0 ], [ 2, [ [ "l10n" ], [ 0 ] ], 0, "title", "{l10n}" ], [ 6, "click", "openLoc" ], [ 6, "mouseenter", "enter" ], [ 6, "mouseleave", "leave" ], [ 3, 1, [ "value" ] ] ] ],
  "5.tmpl": [ [ 3, 1, [ "value", "element" ] ] ],
  "4.tmpl": [ [ 1, 0, [ "element" ], "div", [ 4, [ [ "uvk07v9ibg2ian7n__balloon_", "orientation", 1, "orientation", 0, [ "v-left-top", "v-right-top", "v-center-top", "v-left-bottom", "v-right-bottom", "v-center-bottom" ] ] ], 0, "uvk07v9ibg2ian7n__balloon" ], [ 1, 0, 0, "span", [ 4, [ [ "uvk07v9ibg2ian7n__tail_", "orientation", 1, "orientation", 0, [ "v-left-top", "v-right-top", "v-center-top", "v-left-bottom", "v-right-bottom", "v-center-bottom" ] ] ], 0, "uvk07v9ibg2ian7n__tail" ] ], [ 1, 0, 0, "div", [ 4, 0, 0, "uvk07v9ibg2ian7n__header" ], [ 3, 1, [ "loc" ] ], [ 1, 0, 0, "span", [ 4, 0, 0, "uvk07v9ibg2ian7n__header__comment" ], [ 3, 0, 0, "click to open file in editor" ] ] ], [ 1, 1, [ "source" ], "pre", [ 4, 0, 0, "uvk07v9ibg2ian7n__source" ] ] ] ],
  ...
  "y.js": function(exports, module, basis, global, __filename, __dirname, require, resource, asset) {
    ...
    function pickHandler(event) {
      ...
      if (view) {
        ...
        if (event.altKey) {
          ...
          if (info && info.loc) fileAPI.openFile(info.loc); else console.info("Object create location doesn't resolved:", view, info);
        } else {
    ...
    var nodeInfoPopup = basis.fn.lazyInit(function() {
      return new Balloon({
        ...
        handler: {
          update: function() {
            if (this.data.tmpl) this.show(boxElement); else this.hide();
          },
          hide: function() {
            this.update({
              tmpl: null
  ...
  "10.js": function(exports, module, basis, global, __filename, __dirname, require, resource, asset) {
    ...
    function findParentView(node) {
      ...
      while (cursor && !cursor.__view) cursor = cursor.parentNode;
    ...
    var view = new Node({
      ...
      binding: {
        ...
        objectRenderLoc: selectedView.as(function(ref) {
          if (ref) ref = ref.render || ref.constructor && ref.constructor.render;
          return basis.dev.getInfo(ref, "loc");
        }),
      ...
      action: {
        up: function() {
          ...
          if (view) selectedDomNode.set(view.el);
        },
        close: function() {
          selectedDomNode.set();
        },
  ...
  "11.js": function(exports, module, basis, global, __filename, __dirname, require, resource, asset) {
    ...
    module.exports = function(node) {
      ...
      while (cursor && cursor !== root) {
        ...
        if (!cursor[componentBoundMarker]) {
  ...
  "12.js": function(exports, module, basis, global, __filename, __dirname, require, resource, asset) {
    ...
    var DOMNode = Node.subclass({
      action: {
        ...
        inspect: function() {
          if (this.selectDomNode && this.domNode) this.selectDomNode(this.domNode);
        }
      },
      destroy: function() {
        Node.prototype.destroy.call(this);
    ...
    module.exports = function buildNode(item, bindings, actions, selectDomNode) {
      ...
      switch (node.nodeType) {
        case 1:
          ...
          attrs = binding || nestedView ? basis.array(node.attributes).map(function(attr) {
            return {
              name: attr.name,
              childNodes: [ {
                type: "static",
    ...
    module.exports = new Popup({
      ...
      binding: {
        ...
        source: function(node) {
          return node.loc.as(function(loc) {
            if (loc) return getColoredSource(loc, 0, 0, 15);
          });
        }
      },
      zIndex: 65e3,
...
(function createBasisInstance(context, __basisFilename, __config) {
  ...
  var devInfoResolver = function() {
    ...
    var resolver = config.devInfoResolver || {};
    var test = {};
