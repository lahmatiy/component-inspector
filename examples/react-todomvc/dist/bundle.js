...
/***/ function(module, exports, __webpack_require__) {
	...
	Function('d,e','if(!d[e]){var a=d.WeakMap,c,h;if("function"===typeof a&&/\[native code\]/.test(a)){var k=new a;c=function(b,a,c){if(a&&b&&("object"===typeof b||"function"===typeof b)){var f=k.get(b);(c||!f||f.blackbox&&!a.blackbox)&&k.set(b,a)}return b};h=function(b){if(b)return k.get(b)}}else d.console&&console.info(e+" API is not available (native WeakMap support required)"),c=function(b){return b},h=function(){};a=c;a.set=c;a.get=h;a.wrapDecorator=function(b,a,d){return function(f){d&&c(f,d);var g=b.apply(this,arguments);if(g&&g!==f){var e=h(g)||{};e.wrapper=a;a.target=f;c(g,e)}return g}};d[e]=a}\n//@ sourceURL=/babel-plugin-source-wrapper/runtime.js')(window,"string"==typeof DEVINFO_API_NAME?DEVINFO_API_NAME:"$devinfo")
	;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsHeader = __webpack_require__(181);
	
	var _componentsHeader2 = _interopRequireDefault(_componentsHeader);
	
	var _componentsMainSection = __webpack_require__(184);
	
	var _componentsMainSection2 = _interopRequireDefault(_componentsMainSection);
	
	var _actionsTodos = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoTextInput = (function (_Component) {
	  ...
	  _createClass(TodoTextInput, [{
	    ...
	    key: 'render',
	    value: ($devinfo)(function () {
	      return ($devinfo)(_react2['default'].createElement('input', { className: (0, _classnames2['default'])(($devinfo)({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainSection = (function (_Component) {
	  ...
	  _createClass(MainSection, [{
	    ...
	    key: 'renderToggleAll',
	    value: ($devinfo)(function (markedCount) {
	      var _props2 = this.props;
	      var todos = _props2.todos;
	      var actions = _props2.actions;
	
	      if (todos.length > 0) {
	        return ($devinfo)(_react2['default'].createElement('input', { className: 'toggle-all',
	          type: 'checkbox',
	    ...
	    value: ($devinfo)(function (markedCount) {
	      ...
	      if (todos.length) {
	        return ($devinfo)(_react2['default'].createElement(_Footer2['default'], { markedCount: markedCount,
	  ...
	  _createClass(TodoItem, [{
	    ...
	    value: ($devinfo)(function () {
	      ...
	      if (this.state.editing) {
	        element = ($devinfo)(_react2['default'].createElement(_TodoTextInput2['default'], { text: todo.text,
	        ...
	        element = ($devinfo)(_react2['default'].createElement(
	          'div',
	          { className: 'view' },
	          ($devinfo)(_react2['default'].createElement('input', { className: 'toggle',
	            type: 'checkbox',
	            checked: todo.marked,
	      ...
	      return ($devinfo)(_react2['default'].createElement(
	        'li',
	        { className: (0, _classnames2['default'])(($devinfo)({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantsActionTypes = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = ($devinfo)([($devinfo)({
	  text: 'Use Redux',
	  marked: false,
	  id: 0
	}, {
